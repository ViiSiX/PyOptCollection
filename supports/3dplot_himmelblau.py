...
from py_opt_collection.test_functions import HIMMELBLAU as OptTarget
...
plt.xlabel('X axis (-5, 5)')
plt.ylabel('Y axis (-5, 5)')
plt.title('Plot of Himmelblau function.', y=-0.1)
plt.show()
